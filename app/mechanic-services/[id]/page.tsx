              ...
              <div className="card-surface p-6">
                <div className="flex items-center gap-2 mb-5">
                  <div className="w-9 h-9 rounded-xl bg-emerald-100 flex items-center justify-center">
                    <FiTool size={18} className="text-emerald-600" />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {specialistInfo.objectName && (
                    <div className="p-4 rounded-xl bg-brand-bg border border-brand-border">
                      <p className="text-xs text-brand-muted-fg mb-1">
                        Servis adı
                      </p>
                  ...
                  {specialistInfo.city && (
                    <div className="p-4 rounded-xl bg-brand-bg border border-brand-border">
                      <p className="text-xs text-brand-muted-fg mb-1">Şəhər</p>

                      <p className="text-sm font-semibold text-brand-fg">
                        {getCityTitle(specialistInfo.city)}
                      </p>
                    </div>
                  )}

                  {specialistInfo.rawAddress && (
                    <div className="p-4 rounded-xl bg-brand-bg border border-brand-border sm:col-span-2">
                      <p className="text-xs text-brand-muted-fg mb-1">Ünvan</p>
                  ...
                  {specialistInfo.bio && (
                    <div className="p-4 rounded-xl bg-brand-bg border border-brand-border sm:col-span-2">
                      <p className="text-xs text-brand-muted-fg mb-1">Bio</p>

                      <p className="text-sm leading-6 text-brand-fg whitespace-pre-line">
                        {specialistInfo.bio}
                      </p>
                    </div>
                  )}
